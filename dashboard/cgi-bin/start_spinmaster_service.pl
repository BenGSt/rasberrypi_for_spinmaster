...
$url = "/index.html";
print "Location: $url\n\n";
exec("echo fm_target_temperature $fm_target_temperature reservoir_target_temperature $reservoir_target_temperature flow_rate $flow_rate run_time $run_time  > /tmp/cgi_test.txt");
