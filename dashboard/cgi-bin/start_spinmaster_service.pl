...
$url = "/index.html";
print "Location: $url\n\n";
exec(`sudo bash -c "echo fm_target_temperature $fm_target_temperature reservoir_target_temperature $reservoir_target_temperature flow_rate $flow_rate run_time $run_time  > /home/pi/spinmaster_service_env_file"`);
